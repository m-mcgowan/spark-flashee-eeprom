...
${OBJECTDIR}/_ext/1472/flashee-eeprom.o: ../flashee-eeprom.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1472/flashee-eeprom.o ../flashee-eeprom.cpp

${OBJECTDIR}/CircularBufferTest.o: CircularBufferTest.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CircularBufferTest.o CircularBufferTest.cpp

${OBJECTDIR}/FakeFlashDeviceTest.o: FakeFlashDeviceTest.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FakeFlashDeviceTest.o FakeFlashDeviceTest.cpp

${OBJECTDIR}/FlashDeviceRegionTest.o: FlashDeviceRegionTest.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FlashDeviceRegionTest.o FlashDeviceRegionTest.cpp

${OBJECTDIR}/FlashDeviceTest.o: FlashDeviceTest.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FlashDeviceTest.o FlashDeviceTest.cpp

${OBJECTDIR}/FlasheeTest.o: FlasheeTest.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FlasheeTest.o FlasheeTest.cpp

${OBJECTDIR}/LogicalPageMapperTest.o: LogicalPageMapperTest.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/LogicalPageMapperTest.o LogicalPageMapperTest.cpp

${OBJECTDIR}/MultiWriteFlashStoreTest.o: MultiWriteFlashStoreTest.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MultiWriteFlashStoreTest.o MultiWriteFlashStoreTest.cpp
...
${OBJECTDIR}/gmock-gtest-all.o: gmock-gtest-all.cc 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gmock-gtest-all.o gmock-gtest-all.cc
